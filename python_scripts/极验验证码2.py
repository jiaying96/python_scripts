...
time.sleep(1)
# 点击  点击选择式
#//*[@id='gt-sensebot-mobile']/div[2]/section[3]/div/div[2]/div[1]/ul/li[3]/h2/div/div
click = browser.find_element_by_xpath("//*[@id='gt-sensebot-mobile']/div[2]/section[3]/div/div[2]/div[1]/ul/li[3]").click()
time.sleep(1)
# 点击  点击按钮进行验证 //*[@id="captcha"]/div[3]
play = browser.find_element_by_xpath("//*[@id='captcha']/div[3]").click()
time.sleep(5)
